...
describe('utils-date', () => {
  it('dateFormat', () => {
    ...
    const list = [
      ...
      ['yyyy-MM-ddThh:mm:ss.S', new Date(1_649_211_013_915), '2022-04-06T10:10:13.915'],
    ] as const;
  ...
  it('getDateTimeByTimeZone', () => {
    const list = [
      [8, new Date(1_649_211_013_915), 1_649_211_013_915],
      [-8, new Date(1_649_211_013_915), 1_649_153_413_915],
      [0, new Date(1_649_211_013_915), 1_649_182_213_915],
    ] as const;
  ...
  it('toLocalTime', () => {
    const list = [
      [new Date(1_649_211_013_915), 8, 1_649_211_013_915],
      [new Date(1_649_211_013_915), 0, 1_649_182_213_915],
